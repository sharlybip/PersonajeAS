...
public class PrincipalWinnieActivity extends AppCompatActivity {
    Button personajes;
    Button jugar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_winnie);
        ...
        if (numero_aleatorio == 0 || numero_aleatorio == 10){
            ...
            id =  getResources().getIdentifier("rito", "drawable", getPackageName());
            iv_personaje.setImageResource(id);
        ...
        mp = MediaPlayer.create(this,R.raw.winnie);
        mp.start();
        mp.setLooping(true);
        ...
        personajes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.stop();
                mp.release();
                Intent intent = new Intent(PrincipalWinnieActivity.this, PersonajesWinnieActivity.class);
        ...
        jugar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.stop();
                mp.release();
                Intent intent = new Intent(PrincipalWinnieActivity.this, JuegoWinnieActivity.class);
                startActivity(intent);
                finish();
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if(keyCode == event.KEYCODE_BACK){
            mp.stop();
            mp.release();
            Intent intent = new Intent(PrincipalWinnieActivity.this, MenuJuegosActivity.class);
            startActivity(intent);
            finish();
        }
